...
| --- | --- | --- |
| **Scenes** | `PopReveal`, `BlockShuffle`, `StickerBurst`, `Checklist`, `Stamp`, `Ticker` | The app's built-in motion scenes, drawn by the same code klndr plays live (`protected/js/motion/scenes.js`). |
