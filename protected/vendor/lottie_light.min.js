/*! lottie-web@5.13.0 (MIT) - copied by scripts/vendor-browser-libs.js. Plays Lottie headers. The light build on purpose: SVG renderer only, and no expression support, so a Lottie file has no route to eval(). */
